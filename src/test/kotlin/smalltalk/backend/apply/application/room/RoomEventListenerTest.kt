...
//import smalltalk.backend.application.room.RoomImplementImpl
...
//        val handler = TestHandler(destination, System::class.java)
...
//                text shouldBe (it.name + SystemTextPostfix.OPEN)
//            }
//        }
//    }
//
...
//                text shouldBe (RoomImplementImpl.NICKNAME_PREFIX + it.last() + SystemTextPostfix.ENTRANCE)
//            }
//        }
//    }
//
...
//                add(MEMBER.key, memberIdToDelete.toString())
//            }
//        )
//        val messages = handler.awaitMessage()
//
...
//                last().text shouldBe (RoomImplementImpl.NICKNAME_PREFIX + memberIdToDelete + SystemTextPostfix.EXIT)
